      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Realize LTCG gains up to ₹1 Lakh tax-free before the financial year ends.
          </p>
        </div>
      ...
      <Card className="border-green-500/30 bg-green-500/5">
        <CardContent className="pt-4 pb-4">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground">What is Gain Harvesting?</strong> Under Section 112A of the Income Tax Act, LTCG up to ₹1,00,000 per financial year are exempt from tax. By strategically selling appreciated stocks, you lock in these tax-free gains and reset your cost basis — saving thousands in future tax liability.
          </p>
        </CardContent>
      </Card>
      ...
      {loading ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Stocks from your portfolio identified for gain harvesting this financial year.</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                ...
                {recommendations.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={2} className="text-center text-muted-foreground py-12">
                      No gain harvesting opportunities identified at this time.
                    </TableCell>
                  </TableRow>
