...
import { TrendingDown, RefreshCw, Sparkles, ChevronDown, ChevronUp, Clock, Code2, Wallet } from "lucide-react"
          ...
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              {error.includes("No assets found")
                ? "You don't have any holdings in your portfolio yet. Add stocks in the Portfolio page first, then come back here to get AI-powered loss harvesting recommendations."
                : error}
            </p>
